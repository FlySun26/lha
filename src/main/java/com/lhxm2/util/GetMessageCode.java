...
public class GetMessageCode {
	...
	private static final String ACCOUNT_SID="265e7962a5cf4e5382c2752aa816fd3e";
	private static final String AUTH_TOKEN="3be76341584945e9871bb051c6f92dd8";
	...
	public static String getCode(String phone) throws JSONException {
		...
		String tamp="【六盘科技】您的验证码为"+rod+"，请于"+1+"分钟内正确输入，如非本人操作，请忽略此短信。";
